...
query = """
WITH base AS (
    SELECT * FROM `careful-span-456811-f9.pagila_productionpublic.film_actor`
),
final AS (
    SELECT 
            actor_id,
...
# Full table id
full_table_id = f"careful-span-456811-f9.staging_db.stg_film_actor"
...
if table_exists(client, full_table_id):
    to_gbq(df, f"staging_db.stg_film_actor", project_id=project_id, if_exists='replace')
