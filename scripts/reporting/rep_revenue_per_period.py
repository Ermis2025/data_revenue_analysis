...
# Full table ID
full_table_id = f"careful-span-456811-f9.reporting_db.rep_revenue_per_period"
...
if table_exists(client, full_table_id):
    df.to_gbq(f"reporting_db.rep_revenue_per_period", project_id=project_id, if_exists='replace')
